...
注意比较两个式子间 dx 与 dx 的不同。 使用 `\operatorname` 命令也可以达到相同的效果，详见“[定义新的运算符](http://home.ustc.edu.cn/~zzx2002/new/2021/08/04/mathjax/ş定义新的运算符-operatorname)”。
